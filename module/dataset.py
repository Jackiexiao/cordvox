...
class WaveFileDirectory(torch.utils.data.Dataset):
    def __init__(self, source_dir_paths=[], length=24000, max_files=-1, sample_rate=48000):
        super().__init__()
        print("Loading Data")
        self.path_list = []
        self.data = []
...
class WaveFileDirectoryWithF0(torch.utils.data.Dataset):
    def __init__(self, source_dir_paths=[], length=96000, max_files=-1, sample_rate=48000, segment_size=960):
        super().__init__()
        print("Loading Data")
        self.path_list = []
        self.data = []
